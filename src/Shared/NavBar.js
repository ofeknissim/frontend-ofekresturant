...
const NavBar = () => {
  ...
  return (
    <>
      <nav
        className={`bg-black text-white shadow-lg font-JosefinSans sticky ${
      ...
      >
        <div className="container flex justify-between">
          ...
          <div className="flex items-center justify-between">
            <div className="mr-6">
              <Link to="/">
                  <img style={{ width: 110, height:110}} src={Logo} alt="logo"/>
              </Link>
            </div>
          ...
          <div className="hidden lg:flex items-center justify-center">
            <span className="!text-secondary mr-4">
               <img style={{ width: 70, height:70}} src={Scooter} alt="scooter"/>
            </span>
            <div>
